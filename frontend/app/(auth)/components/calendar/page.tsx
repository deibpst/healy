'use client'; //se usa para cargalo del lado del cliente y poder ocupar cosas como useState
							...
							<div className="flex gap-2">
								{/*<button
									...
									className={`px-4 py-2 text-sm rounded-lg transition-colors ${
										viewMode === 'Day' ? 'bg-gray-100 text-gray-700' : 'text-gray-600 hover:bg-gray-50'
									}`}
								>
									Day
								</button>
								<button
									...
									className={`px-4 py-2 text-sm rounded-lg transition-colors ${
										viewMode === 'Week' ? 'bg-gray-100 text-gray-700' : 'text-gray-600 hover:bg-gray-50'
									}`}
								>
									Week
								</button>*/}  
